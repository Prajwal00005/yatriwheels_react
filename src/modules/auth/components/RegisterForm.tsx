...
const UserRegistration: React.FC<RegisterDialog> = ({ onCancel }) => {
  ...
  return (
    <div className="fixed mt-10 inset-0 bg-black/50 flex justify-center items-center z-50">
      <div className="h-auto w-full max-w-[90%] md:max-w-[600px] md:h-[80%] m-[10%] rounded-lg bg-gray-50 shadow-md overflow-hidden">
        <form
          className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full p-5"
          onSubmit={handleSubmit(handleFormSubmit)}
          noValidate
        >
          <h1 className="col-span-full font-bold text-blue-600 text-lg tracking-wider my-3 text-center">
            Please fill in the user registration form
          </h1>

          {/* Full Name */}
          <div className="flex flex-col">
            <label htmlFor="name" className="text-gray-600 text-sm mb-1">Full Name *</label>
            <input
              id="name"
              className="border border-gray-300 rounded-md p-1.5 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
              {...register("name")}
              type="text"
              placeholder="Enter Full Name"
              aria-invalid={errors.name ? "true" : "false"}
          ...
          {/* Email */}
          <div className="flex flex-col">
            <label htmlFor="email" className="text-gray-600 text-sm mb-1">Email Address *</label>
            <input
              id="email"
              className="border border-gray-300 rounded-md p-1.5 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
              {...register("email")}
          ...
          {/* Phone Number */}
          <div className="flex flex-col">
            <label htmlFor="phone" className="text-gray-600 text-sm mb-1">Phone Number *</label>
            <input
              id="phone"
              className="border border-gray-300 rounded-md p-1.5 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
              {...register("phone")}
          ...
          {/* Password */}
          <div className="flex flex-col">
            <label htmlFor="password" className="text-gray-600 text-sm mb-1">Password *</label>
            <input
              id="password"
              className="border border-gray-300 rounded-md p-1.5 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
              {...register("password")}
          ...
          {/* Confirm Password */}
          <div className="flex flex-col">
            <label htmlFor="confirmPassword" className="text-gray-600 text-sm mb-1">Confirm Password *</label>
            <input
              id="confirmPassword"
              className="border border-gray-300 rounded-md p-1.5 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
              {...register("confirmPassword")}
          ...
          {/* State */}
          <div className="flex flex-col">
            <label htmlFor="state" className="text-gray-600 text-sm mb-1">State *</label>
            <input
              id="state"
              className="border border-gray-300 rounded-md p-1.5 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
              {...register("state")}
          ...
          {/* Address */}
          <div className="flex flex-col">
            <label htmlFor="address" className="text-gray-600 text-sm mb-1">Address *</label>
            <input
              id="address"
              className="border border-gray-300 rounded-md p-1.5 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
              {...register("address")}
          ...
          {/* File input for Image */}
          <div className="flex flex-col col-span-full">
            <label htmlFor="image" className="text-gray-600 text-sm mb-1">Profile Picture</label>
            <input
              id="image"
          ...
          {/* Buttons */}
          <div className="col-span-full flex flex-col sm:flex-row justify-center gap-3 mt-4">
            <button
              className="px-4 py-1.5 bg-blue-500 text-white rounded-md text-sm hover:bg-blue-600 transition disabled:opacity-50"
              type="submit"
              disabled={isSubmitting}
              aria-label="Submit registration form"
            >
